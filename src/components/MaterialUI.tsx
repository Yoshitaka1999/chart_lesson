...
const MaterialUI: React.FC = () => {
  ...
  return (
    <div>
      <Typography color="secondary" variant="h1" align="left" gutterBottom noWrap className={classes.typoStyle}>Hello UI</Typography>
      ...
      <Grid container spacing={1} direction="column" justifyContent="center" alignItems="flex-end">
          <Grid item xs={1}>
